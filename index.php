        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="index.php" class="navbar-brand">Lanie</a>
                    </li>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active">
                    <img src="img/mug1.jpg" alt="Los Angeles" style="width:100%;">
                ...
                <div class="item">
                    <img src="img/w_coat2.jpg" alt="Chicago" style="width:100%;">
                    <div class="carousel-caption">
                        <h3>Upcoming!!!</h3>
                        <p>Best Products...</p>
                    </div>
                ...
                <div class="item">
                    <img src="img/per1.jpg" alt="New York" style="width:100%;">
                    <div class="carousel-caption">
                        <h3>Upcoming!!!</h3>
                        <p>Best Products...</p>
                    </div>
